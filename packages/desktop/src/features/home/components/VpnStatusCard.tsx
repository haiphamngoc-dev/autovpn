...
export function VpnStatusCard() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("vpn-settings-changed", handleSettingsChange);
    handleSettingsChange();

    return () => {
      window.removeEventListener("vpn-settings-changed", handleSettingsChange);
    };
  }, []);
  ...
  useEffect(() => {
    ...
    if (isConnected) {
      void listen<{ downloadSpeed: string; uploadSpeed: string }>(
        "vpn-stats-updated",
        (event) => {
      ...
      <div className={styles.layout}>
        ...
        <div className={styles.body}>
          ...
          {stats && (
            ...
            >
              <span>⬇️ {stats.downloadSpeed}</span>
              <span>•</span>
              <span>⬆️ {stats.uploadSpeed}</span>
            </Text>
          )}
        </div>
      </div>
